...
export default function DocumentationRefreshCard({ docs }) {
  return (
    <header className="border-2 border-Teal400 rounded-2xl p-8 lg:shadow-sm bg-gradient-to-br from-SCyan to-ECyan ">
      <div className="flex flex-col md:flex-row justify-between items-start mb-4">
        ...
        <button className="flex items-center gap-2 px-4 py-2 bg-background border-2 border-Teal400 rounded-lg text-sm  text-Gray600 font-medium hover:bg-Cyan50 transition-colors">
