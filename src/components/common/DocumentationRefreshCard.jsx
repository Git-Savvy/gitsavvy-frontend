import FeedbackBox from "../layout/Docs/FeedBackBox";
      ...
      <div className="flex">
        <div className="flex flex-col" >
          ...
          <p className="text-Gray600 leading-relaxed max-w-8xl text-lg">
            Turn complex codebases into clear, easy-to-navigate documentation.
            Our AI analyzes your repository and generates structured
            explanations directly from the source code. Browse the project
            through an interactive explorer, open any file, and instantly see
            meaningful insights, summaries, and relevant code context. It’s a
            faster way to understand how a project works, without digging
