export default function MyWorkNav({ activeTab, setActiveTab }) {
  ...
  return (
    <div className="flex  flex-col md:flex-row gap-2 lg:gap-8 justify-around border-2 border-NavBorder bg-Nav rounded-2xl md:rounded-full p-1  w-full md:w-fit lg:shadow-sm ">
      {tabs.map((tab) => (
        <button
          key={tab.id}
