    ...
    <div className="border-2 border-gray-200 rounded-xl bg-white p-8 lg:shadow-sm">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 leading-relaxed">
          Infrastructure as code templates for AWS, Azure, and GCP. This project
          aims to provide developers with a robust, production-ready solution
          that follows best practices and modern development standards.
        </p>
      </div>
