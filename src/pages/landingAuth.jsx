...
const Landing = () => {
  ...
  return (
    <div className="h-screen bg-background ">
      <section className="min-h-screen flex items-center justify-center m-5 ">
        <div className=" md:1rem md:m-auto ">
          <div className="w-full h-[10%] flex justify-end mb-5">
            <ThemeSwitcher />
          </div>
          <div className="container  lg:mx-auto  grid grid-cols-1 lg:grid-cols-2 gap-15 items-center ">
            {/* LEFT SIDE */}
            <div>
              {/* Logo */}
              <div className="flex items-center mb-6">
                <img
                  src={img}
                  alt="logo"
                  className=" w-[18rem] md:w-[20rem] md:w-100 lg:w-md h-auto object-contain rounded"
                />
              </div>

              {/* Heading */}
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-simibold text-textdark leading-tight mb-10">
              ...
              <p className="text-text-secondary text-2xl mb-12 mr-30">
                Discover perfect repositories, streamline contributions, and
                build your developer reputation all in one intelligent platform.
              </p>
